...
Blockly.DataCategory = function (workspace) {
  ...
  if (variableModelList.length > 0) {
    ...
    Blockly.DataCategory.addSetListToSplit(xmlList, firstVariable);
    Blockly.DataCategory.addSep(xmlList);
...
Blockly.DataCategory.addSetListToSplit = function (xmlList, variable) {
  Blockly.DataCategory.addBlock(xmlList, variable, 'data_setlisttosplit',
    'LIST', ['STRING', 'text', "4,5,6"], ['CHARACTER', 'text', ","]);
};
